    ...
    public static void main(String[] args) {
        try (
                DataOutputStream out = new DataOutputStream(new BufferedOutputStream(
                        new FileOutputStream("com/test/java/ch21/out3_dataoutputstream.txt")));
        ) {
        ...
        try (
                DataInputStream in = new DataInputStream(new BufferedInputStream(
                        new FileInputStream("com/test/java/ch21/out3_dataoutputstream.txt")));
        ) {
        ...
        try (
                ObjectOutputStream out = new ObjectOutputStream(new BufferedOutputStream(
                        new FileOutputStream("com/test/java/ch21/out3_objectoutputstream.txt")));
        ) {
        ...
        try (
                ObjectInputStream in = new ObjectInputStream(new BufferedInputStream(
                        new FileInputStream("com/test/java/ch21/out3_objectoutputstream.txt")));
        ) {
