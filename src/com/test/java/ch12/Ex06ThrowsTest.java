    ...
    public static void main(String[] args) throws MoneyIsNotEnough1 {
        ...
        while(guest.isVisit()) {
            try {
                ...
                MachineService1.validateInspect(guest);
            } catch (MoneyIsNotEnough1 e) {
...
class MachineService1 {
    ...
    public static void validateInspect(Guest1 guest) throws MoneyIsNotEnough1 {
    ...
    public static void success(Guest1 guest) throws MoneyIsNotEnough1 {
        guest.setBalance(guest.getBalance() - arr[guest.getPick()-1].getPrice());
...
class TypeIsWrong extends Exception {
    public TypeIsWrong(String message) {
        super(message);
    }
}